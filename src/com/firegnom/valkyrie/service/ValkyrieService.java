...
public class ValkyrieService extends Service {
	...
	private final IGameService.Stub gameBinder = new IGameService.Stub() {
		@Override
		public void changeGameMode(final int mode) throws RemoteException {
			serverConnection.sendChangeGameMode(mode);
		}

		@Override
		public void createUser(final ICreateUserCallback callback,
				final int selectedClass) throws RemoteException {
		...
		@Override
		public void registerCallback(final IGameServiceCallback callback)
				throws RemoteException {
	...
	private final IChatService.Stub chatBinder = new IChatService.Stub() {
		...
		@Override
		public void registerCallback(final IChatServiceCallback callback)
				throws RemoteException {
	...
	private void showNotification() {
		final CharSequence text = getText(R.string.valkyrie_service_started);
